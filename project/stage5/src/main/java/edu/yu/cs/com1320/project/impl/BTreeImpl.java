...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key, Value>{ 
    ...
    public Value get(Key k) {
        ...
        if(entry != null)
        {
            if (entry.val instanceof Document || entry.val == null){
                entry.val = (entry.val);
            }else{
                try {
                    entry.val = this.manager.deserialize(k);
                    manager.delete(k);
    ...
    public Value put(Key k, Value v) {
        ...
        {
            Object objVal = alreadyThere.val;
            alreadyThere.val = v;
            if (objVal instanceof Document || objVal== null){
                ...
                // try {
                //     objVal = this.manager.deserialize(k);
            ...
            return (Value) objVal;// not sure abt. bc what if its a refference to disk...??
        }else{
            Node newNode = this.put(this.root, k, v, this.height);
            this.n++;
            if (newNode == null)
            {
                return null; //did this myself
            }else{
                //split the root:
    ...
    public void moveToDisk(Key k) throws Exception {
        ...
        this.manager.serialize(k, doc);
        Object valueString = "hello";
        this.put(k,(Value)valueString);
        //i think its done
        // need to also change the value of this URI from being a document to being a refference to Doc on disk

        // dwejuhfdqwoihfesuygfsjksbfjgsjgfw
