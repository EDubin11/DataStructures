...
public class zfirstDocStoreTrieTest {
    ...
    public void init() throws Exception {
        ...
        this.txt1 = "Th the that th";

        //init possible values for doc2
        this.uri2 = new URI("http://edu.yu.cs/com1320/project/doc2");
        this.txt2 = "Th there t";

        this.uri3 = new URI("http://edu.yu.cs/com1320/project/doc3");
        this.txt3 = "There are th them these";
    }
    ...
    public void testTrie() throws IOException {
        DocumentStore store = new DocumentStoreImpl();
        int r = store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        int returned = store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        assertTrue(returned == 0);

        int a = store.putDocument(new ByteArrayInputStream(this.txt3.getBytes()),this.uri3, DocumentStore.DocumentFormat.TXT);


        List<Document> results = store.searchByPrefix("t");

        System.out.println(results);
         for (Document j: results){
             System.out.println(j.getDocumentTxt());
         }
    }
